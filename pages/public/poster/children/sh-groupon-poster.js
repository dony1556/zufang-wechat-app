          ...
          e = {
            ...
            created: function () {
              ...
              (t.goodsInfo = t.$Route.query),
                ...
                t.setShareInfo({
                  query: { url: "groupon-" + t.$Route.query.id },
                                      ...
                                      new Promise(function (t, e) {
                                        t([
                                          ...
                                          },
                                          {
                                            ...
                                            textBaseline: "middle",
                                            lineFeed: {
                                              maxWidth: 0.91 * n.width,
                                              lineHeight: 0.06 * n.width,
                                              lineNum: 2,
                                              dx: -1,
                                            },
                                            infoCallBack: function (t) {
                                          ...
                                          },
                                          {
                                            ...
                                            alpha: 1,
                                            drawDelayTime: 500,
                                            dx: n.width - 0.2 * n.width,
                                            dy: n.height - 0.18 * n.width,
                                            infoCallBack: function (t) {
                                              return {
                                                dWidth: 0.14 * n.width,
                                                dHeight: 0.14 * n.width,
                                              };
                                            },
                                          },
                                        ]);
