(global.webpackJsonp = global.webpackJsonp || []).push([
    ...
    3732: function (e, t, i) {
      (function (n) {
        ...
        e = {
          components: {
            pubNav: function () {
              i.e("pages/work/components/pub-nav")
                .then(
                  function () {
                    return resolve(i("db03"));
                  }.bind(null, i)
                )
                .catch(i.oe);
            },
            pubAd: function () {
              i.e("pages/work/components/pub-ad")
                .then(
                  function () {
                    return resolve(i("fa00"));
                  }.bind(null, i)
                )
                .catch(i.oe);
            },
            pubBanner: function () {
              i.e("pages/work/components/pub-banner")
                .then(
                  function () {
                    return resolve(i("e443"));
                  }.bind(null, i)
                )
                .catch(i.oe);
            },
            pubImg: function () {
              i.e("pages/work/components/pub-img")
                .then(
                  function () {
                    return resolve(i("af40"));
                  }.bind(null, i)
                )
                .catch(i.oe);
            },
          ...
          methods: {
            ...
            getPubData: function () {
              var t = this;
              this.$api("index.getPubData", { role: "fd" }).then(function (e) {
                e.data.items && (t.items = e.data.items),
                  e.data.pub_set && (t.pub_set = e.data.pub_set),
                  3 == e.data.code &&
                    n.showModal({
                      title: "提示",
                      content: e.data.msg,
                      showCancel: !1,
                      success: function () {
                        t.$Router.pushTab({ path: "/pages/index/index" });
                      },
                    });
              });
            },
  ...
  [["d9ef", "common/runtime", "common/vendor"]],
]);
