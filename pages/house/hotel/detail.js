require("../common/vendor.js"),
  (global.webpackJsonp = global.webpackJsonp || []).push([
        ...
        (function (t) {
          ...
          n = {
            ...
            methods: {
              ...
              getPoster: function () {
                var n = this;
                this.$api("poster.housePoster", { houseId: n.house.id }).then(
                  function (e) {
                    0 == e.errno
                      ? 0 == e.data.code
                        ? (n.board = e.data.obj)
              ...
              getHouseDetail: function () {
                var n = this;
                n.$api("house.hotelDetail", { houseId: n.house.id }).then(
                  function (e) {
                    0 == e.errno &&
                      ((n.isLoading = 0),
    ...
    [["54dd", "common/runtime", "common/vendor", "pages/house/common/vendor"]],
  ]);
