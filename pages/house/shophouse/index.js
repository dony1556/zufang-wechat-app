require("../common/vendor.js"),
  (global.webpackJsonp = global.webpackJsonp || []).push([
    ["pages/house/shophouse/index"],
    {
      1723: function (e, t, i) {
        ...
        o = {
          ...
          onLoad: function () {
            var e = this.$Route.query.is_attorn;
            0 <= e &&
              ((this.select_p.is_attorn = e), (this.select_p2.is_attorn = e));
            e = this.$Route.query.type;
            e && ((this.select_p.type = e), (this.select_p2.type = e)),
              this.init();
          },
          onShow: function () {},
          computed: (function (t) {
          ...
          methods: {
            ...
            getSlide: function () {
              var t = this;
              this.$api("index.getSlide", { type: 9 }).then(function (e) {
                t.swiperList = e.data.list;
              });
            },
            selectInit: function () {
              var t = this;
              t.$api("shophouse.selectInit", {
            ...
            getHouses: function () {
              ...
              0 <= this.select_p.mj_index &&
                ...
                this.$api("shophouse.houseList", i).then(function (e) {
                  0 == e.errno &&
                    ((e = e.data.list),
                    1 == t.page
                      ? (t.houseList = e)
        ...
        var n = {
          ...
          s = function () {
              ...
              n =
                ...
                0 < i.select_p2.area_id
                  ? i.__map(i.buildareaList, function (e, t) {
                      return {
                        $orig: i.__get_orig(e),
                        g2: i.select_p2.buildarea_ids.indexOf(e.id),
                      };
                    })
                  : null,
              s =
                i.selectshow && 3 == i.itemIndex
                  ? i.__map(i.originList, function (e, t) {
                      return {
                        $orig: i.__get_orig(e),
                        g3: i.select_p2.origin.indexOf(e.id),
                      };
                    })
                  : null,
              o =
                i.selectshow && 3 == i.itemIndex
                  ? i.__map(i.decorateList, function (e, t) {
                      return {
                        $orig: i.__get_orig(e),
                        g4: i.select_p2.decorate.indexOf(e.name),
                      };
                    })
                  : null,
              r =
            ...
            i.$mp.data = Object.assign(
              {},
              { $root: { g0: e, g1: t, l0: n, l1: s, l2: o, l3: r, l4: a } }
            );
          },
          o = [];
      },
    ...
    [["17c8", "common/runtime", "common/vendor", "pages/house/common/vendor"]],
  ]);
